...
function NavBar() {
    const menuOptions = ["Discover Jinotepe", "Hostals", "Reviews", "Things to do"];
    return (
        <div>
            <nav className="bg-white dark:bg-gray-900 fixed w-full z-40 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src={Logo} className="h-8" alt="XiloteSearch" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap uppercase dark:text-sky-400">
                            Xilotepeando
                        </span>
                    </a>
